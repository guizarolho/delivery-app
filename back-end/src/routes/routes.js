...
router.get('/products/:id', validateAuthField, jwtAuth, salesController.readSaleByUserId);
router.get('/sales/:id', validateAuthField, jwtAuth, salesProductsController.saleProductsById);
